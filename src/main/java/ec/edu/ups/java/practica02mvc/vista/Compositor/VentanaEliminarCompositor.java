...
public class VentanaEliminarCompositor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Eliminar compositor");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 180, 30));
    ...
    private void btnAceptar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptar1ActionPerformed
        ...
        if (confirm == 0) {
            ...
            JOptionPane.showMessageDialog(this, "El Compositor fue eliminado Correctamente");
        } else {
            JOptionPane.showMessageDialog(this, "No fue eliminado");
        }
